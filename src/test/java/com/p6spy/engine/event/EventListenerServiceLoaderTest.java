...
public class EventListenerServiceLoaderTest {
    ...
    public void testServiceLoaderFromWrapConnection() throws Exception {
        ...
        @SuppressWarnings("resource") final Connection connection = ConnectionWrapper.wrap(connectionMock, new DefaultJdbcEventListenerFactory().createJdbcEventListener(), ConnectionInformation.fromTestConnection(connectionMock));
